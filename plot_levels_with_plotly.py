    ...
    for symbol in yield_gerchik_symbol():
        ...
        try:
            ...
            count_low_values_merged_full_df , low_levels_with_2touches , low_levels_with_2touches_all_dates = \
                calculate_horizontal_levels_using_only_lows ( symbol , round_to_this_number_of_decimal_places ,
                                                              number_2level_touches_with_low,level_for_this_period )
            count_low_values_merged_full_df , low_levels_with_3touches , low_levels_with_3touches_all_dates = \
                calculate_horizontal_levels_using_only_lows ( symbol , round_to_this_number_of_decimal_places ,
                                                              number_of_more_than_3level_touches_with_low,level_for_this_period )

            count_high_values_merged_full_df , high_levels_with_2touches , high_levels_with_2touches_all_dates = \
                calculate_horizontal_levels_using_only_highs ( symbol , round_to_this_number_of_decimal_places ,
                                                               number_2level_touches_with_high,level_for_this_period )
            count_high_values_merged_full_df , high_levels_with_3touches , high_levels_with_3touches_all_dates = \
                calculate_horizontal_levels_using_only_highs ( symbol , round_to_this_number_of_decimal_places ,
                                                               number_of_more_than_3level_touches_with_high,level_for_this_period )
